...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/">
        <html>
            ...
            <body>
                ...
                <xsl:call-template name="quicklinks"/>
                <p class="info">You are viewing an HTML version of the XML OAI-PMH response. To see the underlying XML
                    as it appears to any OAI-PMH harvester use your web browser's <em>view source</em> option or disable
                    XSLT processing.
                </p>
                <p class="info">This XSL script was originally written by Christopher Gutteridge at <a
    ...
    <xsl:template name="quicklinks">
        <div class="quicklinks">
            <ul>
                ...
                <li>&#187;
                    <a class="link" href="?verb=ListMetadataFormats">ListMetadataFormats</a>
                </li>
                <xsl:if test="$identifier">
                    <li>&#187;
                        <a class="link" href="?verb=ListMetadataFormats&amp;identifier={$identifier}">
                            ListMetadataFormats (
                            <em>
                ...
                <xsl:if test="$metadataPrefix != ''">
                    <li>&#187;
                        <a class="link" href="?verb=ListIdentifiers&amp;metadataPrefix={$metadataPrefix}">
                            ListIdentifiers (
                            <em>
                    ...
                    <li>&#187;
                        <a class="link" href="?verb=ListRecords&amp;metadataPrefix={$metadataPrefix}">ListRecords (
                            <em>
                                <xsl:value-of select="$metadataPrefix"/>
                            </em>
                            )
                    ...
                    <li>&#187;
                        <a class="link" href="?verb=ListSets&amp;metadataPrefix={$metadataPrefix}">ListSets (
                            <em>
                                <xsl:value-of select="$metadataPrefix"/>
                            </em>
                            )
                    ...
                    <xsl:if test="$identifier">
                        <li>&#187;
                            <a class="link"
                               href="?verb=GetRecord&amp;metadataPrefix={$metadataPrefix}&amp;identifier={$identifier}">
                                GetRecord (
                                <em>
                                    <xsl:value-of select="$identifier"/>
                                </em>
                ...
                <xsl:if test="//oai:resumptionToken">
                    <li>&#187;
                        <a class="link" href="?verb={$verb}&amp;resumptionToken={//oai:resumptionToken}">Resume</a>
                    </li>
                </xsl:if>
            </ul>
        </div>
    ...
    <xsl:template match="/oai:OAI-PMH">
        <table class="values">
            ...
            <tr>
                <td class="key">Request Parameters</td>
                <td class="value">
                    <xsl:if test="oai:request/@verb">verb =
                        <em>
                            <xsl:value-of select="$verb"/>
                        </em>
                        <br/>
                    </xsl:if>
                    <xsl:if test="oai:request/@metadataPrefix">metadataPrefix =
                        <em>
                            <xsl:value-of select="$metadataPrefix"/>
                        </em>
                        <br/>
                    </xsl:if>
                    <xsl:if test="oai:request/@identifier">identifier =
                        <em>
                            <xsl:value-of select="$identifier"/>
                        </em>
                        <br/>
                    </xsl:if>
                    <xsl:if test="oai:request/@from">from =
                        <em>
                            <xsl:value-of select="$from"/>
                        </em>
                        <br/>
                    </xsl:if>
                    <xsl:if test="oai:request/@until">until =
                        <em>
                            <xsl:value-of select="$until"/>
                        </em>
                        <br/>
                    </xsl:if>
                    <xsl:if test="oai:request/@set">set =
                        <em>
                            <xsl:value-of select="$set"/>
                        </em>
                        <br/>
                    </xsl:if>
                    <xsl:if test="oai:request/@resumptionToken">resumptionToken =
                        <em>
        ...
        <ol>
            <li>
                ...
                <table class="values">
                    ...
                    <tr>
                        <td class="key">Administrative Email</td>
                        <td class="value">
                            <a href="mailto:{oai:adminEmail}">
                                <xsl:value-of select="oai:adminEmail"/>
                            </a>
                        </td>
                    </tr>
                </table>
    ...
    <xsl:template match="oai:ListMetadataFormats">
        <xsl:choose>
            <xsl:when test="$identifier">
                <p class="info">This is a list of metadata formats available for the record
                    <em>
                        <xsl:value-of select="$identifier"/>
                    </em>
                    .
    ...
    <xsl:template match="oai:metadataFormat">
        <li>
            ...
            <ul>
                <li>&#187;
                    <a class="link" href="?verb=ListIdentifiers&amp;metadataPrefix={oai:metadataPrefix}">
                        ListIdentifiers
                    </a>
                </li>
                <li>&#187;
                    <a class="link" href="?verb=ListRecords&amp;metadataPrefix={oai:metadataPrefix}">ListRecords</a>
                </li>
                <xsl:if test="$identifier">
                    <li>&#187;
                        <a class="link"
                           href="?verb=GetRecord&amp;metadataPrefix={oai:metadataPrefix}&amp;identifier={$identifier}">
                            GetRecord
                        </a>
                    </li>
                </xsl:if>
    ...
    <xsl:template match="oai:ListSets">
        <p class="info">This is a list of sets' identifiers available for the metadata format
            <em>
                <xsl:value-of select="$metadataPrefix"/>
            </em>
            .
    ...
    <xsl:template match="oai:ListSets/oai:set">
        <li>
            <h3>Set name
                <em>
            ...
            <ul>
                <li>&#187;
                    <a class="link"
                       href="?verb=ListIdentifiers&amp;metadataPrefix={$metadataPrefix}&amp;set={oai:setSpec}">
                        ListIdentifiers
                    </a>
                </li>
                <li>&#187;
                    <a class="link"
                       href="?verb=ListRecords&amp;metadataPrefix={$metadataPrefix}&amp;set={oai:setSpec}">
                        ListRecords
                    </a>
                </li>
            </ul>
    ...
    <xsl:template match="oai:ListIdentifiers">
        <p class="info">This is a list of records' identifiers available for the metadata format
            <em>
                <xsl:value-of select="$metadataPrefix"/>
            </em>
            .
    ...
    <xsl:template match="oai:ListIdentifiers/oai:header">
        <li>
            ...
            <ul>
                <li>&#187;
                    <a class="link" href="?verb=ListMetadataFormats&amp;identifier={oai:identifier}">
                        ListMetadataFormats
                    </a>
                </li>
                <li>&#187;
    ...
    <xsl:template match="oai:ListRecords">
        <p class="info">This is a list of records available for the metadata format
            <em>
                <xsl:value-of select="$metadataPrefix"/>
            </em>
            .
    ...
    <xsl:template match="oai:GetRecord">
        <p class="info">This is the record
            <em>
                <xsl:value-of select="$identifier"/>
            </em>
    ...
    <xsl:template match="oai:record/oai:header">
        ...
        <ul>
            <li>&#187;
                <a class="link" href="?verb=ListMetadataFormats&amp;identifier={oai:identifier}">ListMetadataFormats</a>
            </li>
        ...
        <xsl:if test="@status = 'deleted'">
            <h4>This record has been deleted.</h4>
        </xsl:if>
    </xsl:template>
    ...
    <xsl:template match="oai:resumptionToken">
        ...
        <table class="values">
            <tr>
                <td class="key">Cursor Position</td>
                <td class="value">
                    <xsl:value-of select="@cursor"/>
                </td>
            </tr>
            <tr>
                <td class="key">Total Records</td>
                <td class="value">
                    <xsl:value-of select="@completeListSize"/>
                </td>
            </tr>
            <tr>
                <td class="key">Expiration Datestamp</td>
                <td class="value">
                    <xsl:value-of select="@expirationDate"/>
                </td>
            </tr>
            <tr>
                <td class="key">Resumption Token</td>
                <td class="value">
                    <xsl:value-of select="."/>
                </td>
            </tr>
    ...
    <xsl:template match="node()" mode='xmlMarkup'>
        <div class="xmlBlock">
            ...
            <xsl:apply-templates select="@*" mode='xmlMarkup'/>&gt;<xsl:apply-templates select="node()"
                                                                                        mode='xmlMarkup'/>&lt;/
            <span class="xmlTagName">
                <xsl:value-of select='name(.)'/>
            </span>&gt;
